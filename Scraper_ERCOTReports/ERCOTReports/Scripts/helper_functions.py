...
def download_file_json_format(log_file_path:str, output_folder:str, report_name:str, dct_report_specs:dict, df_log:pd.DataFrame, default_variables, util_scraper) -> None:
    logging = Logging()
